...
leftIndex = 1;
trk.contrast_vector=[0 ];% 87]; % AR added this line pixel={30,37,50,66, 73,79,82,84,87} for contrast={13.5,13,12,10,9,8,7.5,7,6.5}
...
for i = 1:trk.number_of_objects
    ...
    obj(i).background_pix_val = 113; %%AR changed this from 100 to 112
...
% Determine whether the contrast of the object will change
if (rand(1) < 0.33)
    obj(i).contrast=trk.contrast_vector(end); % AR added this line
end
